...
class TimeTool:
    ...
    @classmethod
    def get_week_start_day(cls, current_datetime: Optional[datetime.date] = None) -> datetime.date:
        """ 获取本周周一的日期 """
    ...
    @classmethod
    def get_week_end_day(cls, current_datetime: Optional[datetime.date] = None) -> datetime.date:
        """ 获取本周周日的日期 """
        if current_datetime is None:
            current_datetime = datetime.datetime.now().date()
        current_week_num = current_datetime.weekday()
    ...
    @classmethod
    def get_weekday_list_by_week_range(cls, week_start: datetime.date, week_end: datetime.date) -> list[int]:
